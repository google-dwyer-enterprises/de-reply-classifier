...
- `LEAD_CLEANING_PLAN.md` — Booked-count under-reporting fix (139→200+), name population, reply tracking view. Phase 1b first checked 2026-05-19 (sent_messages was empty then); the sent sync went live 2026-05-22 and `sent_messages` now holds 327k rows, so Phase 4's sync dependency is satisfied at the data level.
